...
from environment.rrt import MujocoRRT
from environment.ur5 import UR5, UR5Robotiq, UR5WSG50Finray
...
from environment.domain_randomizer import (
...
class MujocoUR5Env(MujocoEnv):
    def __init__(
        ...
        num_setup_variations: Optional[int] = None,
        num_pose_variations: Optional[int] = None,
        ground_xml_path: str = "environment/assets/ground.xml",
...
class MujocoUR5WSG50FinrayEnv(MujocoUR5Env):
    ...
    def setup_model(self) -> Tuple[RootElement, str]:
        ...
        robot_model = mjcf.from_path(
            "environment/assets/menagerie/universal_robots_ur5e/ur5e.xml",
        )
        ...
        gripper = mjcf.from_path(
            "environment/assets/wsg50/wsg50_finray_milibar.xml",
        )

        cam_mount_site = gripper.find("site", "cam_mount")
        cam = mjcf.from_path(
            "environment/assets/menagerie/realsense_d435i/d435i_with_cam.xml"
        )
...
class MujocoUR5Robotiq85fEnv(MujocoUR5Env):
    ...
    def setup_model(self) -> Tuple[RootElement, str]:
        ...
        robot_scene_model = mjcf.from_path(
            "environment/assets/ur5-robotiq.xml",
        )
